...
public class CartAnimation {
    ...
    public CartAnimation(Activity activity) {
        ...
        buyImg.setImageResource(R.drawable.ic_plus_one);
        //buyImg.setImageBitmap(bitmap);//也可以这么设置
    ...
    public void startAnim(View startView, View endView) {
        ...
        set.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                //结束后访问数据
                //thread.start();
                //使用thread时有bug（在第二次运行时，会抛出错误：java.lang.IllegalThreadStateException: Thread already started），待修复
            }
        });
    }

    public void plusOneAnim(View startView) {
        startView.getLocationInWindow(start_location);
        View run_view = addViewFromAnimLayout(buyImg, start_location);
